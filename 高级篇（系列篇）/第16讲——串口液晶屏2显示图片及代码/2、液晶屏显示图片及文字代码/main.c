...
{
start:
    Delay1ms(4000);      //等待4000mS
    InitUART();         //UART初始化

    UartSend("DIR(0);CLR(0);\r\n");    // 竖屏显示，清屏命令，黑色背景
    Delay1ms(400);

    UartSend("DIR(0);FSIMG(2097152,0,0,240,320,0);\r\n");      // 竖屏显示图片，第1张图片，编号0
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(2250752,0,0,320,240,0);\r\n");      // 横屏显示图片，第2张图片，编号1
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(2404352,0,0,320,240,0);\r\n");      // 横屏显示图片，第3张图片，编号2
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(2557952,0,0,320,240,0);\r\n");      // 横屏显示图片，第4张图片，编号3
    Delay1ms(1000);

    UartSend("DIR(0);FSIMG(2711552,0,0,240,320,0);\r\n");      // 竖屏显示图片，第5张图片，编号4
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(2865152,0,0,320,240,0);\r\n");      // 横屏显示图片，第6张图片，编号5
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(3018752,0,0,320,340,0);\r\n");      // 横屏显示图片，第7张图片，编号6
    Delay1ms(1000);

    UartSend("DIR(0);FSIMG(3172352,0,0,240,320,0);\r\n");      // 竖屏显示图片，第8张图片，编号7
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(3325952,0,0,320,240,0);\r\n");      // 横屏显示图片，第9张图片，编号8
    Delay1ms(1000);

    UartSend("DIR(1);FSIMG(3479552,0,0,320,240,0);\r\n");      // 横屏显示图片，第10张图片，编号9
    Delay1ms(1000);
